...
const blog5 = [
  ...
  const filteredblog5 =
    activeCategory === "All"
      ? blog5
      : blog5.filter((blog5) =>
          blog5.categories.includes(activeCategory)
        );
...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-5xl ml-8">
    <h1 className="text-5xl sm:text-6xl font-bold uppercase leading-tight mb-4">
       {translations.heroBlog5?.title || "Loading..."}
    </h1>
    <div className="w-24 h-1 bg-white mb-4" />
   <p className="flex items-center gap-2">
  <FaHome className="text-[#ffffff]" />
  / <span className="font-semibold text-[#58a3ff]">{translations.heroBlog5?.breadcrumb || "Loading..."}</span>
</p>
  </div>
</section>
...
<section className="py-10 px-6 bg-white">
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    ...
    <div className="space-y-10">
      {filteredblog5.map((item, index) => {
        const blog5 = translations.blog5?.[item.key];
        const meta = translations.blog1Meta || {};

        if (!blog5) return null;
    ...
    <span className="ml-1">8116</span>
       ...
       {/* Blog Body */}
            <div className="space-y-4 text-[#4F4F4F] text-base leading-relaxed">
              {blog5.title1 && (
                <>
                  <h4 className="font-semibold text-black mb-1">{blog5.title1}</h4>
                  {blog5.description1 && <p className="mt-0">{blog5.description1}</p>}
                </>
              )}
              {blog5.description1_2 && <p>{blog5.description1_2}</p>}

              {blog5.title2 && (
                <>
                  <h4 className="font-semibold text-black mb-1">{blog5.title2}</h4>
                  {blog5.description2 && <p className="mt-0">{blog5.description2}</p>}
                </>
              )}
              {blog5.description2_2 && <p>{blog5.description2_2}</p>}
              {blog5.description2_3 && <p>{blog5.description2_3}</p>}
              {blog5.description2_4 && <p>{blog5.description2_4}</p>}
              {blog5.description2_5 && <p>{blog5.description2_5}</p>}

              {blog5.title3 && (
                <>
                  <h4 className="font-semibold text-black mb-1">{blog5.title3}</h4>
                  {blog5.description3 && <p className="mt-0">{blog5.description3}</p>}
                </>
              )}
              {blog5.description3_2 && <p>{blog5.description3_2}</p>}
              {blog5.description3_3 && <p>{blog5.description3_3}</p>}
              {blog5.description3_4 && <p>{blog5.description3_4}</p>}
              {blog5.description3_5 && <p>{blog5.description3_5}</p>}
              {blog5.description3_6 && <p>{blog5.description3_6}</p>}
              {blog5.description3_7 && <p>{blog5.description3_7}</p>}


              {blog5.title4 && (
                <>
                  <h4 className="font-semibold text-black mb-1">{blog5.title4}</h4>
                  {blog5.description4 && <p className="mt-0">{blog5.description4}</p>}
                </>
              )}
              {blog5.description4_2 && <p>{blog5.description4_2}</p>}
             {blog5.title5 && (
                <>
                  <h4 className="font-semibold text-black mb-1">{blog5.title5}</h4>
                  {blog5.description5_2 && <p className="mt-0">{blog5.description5_2}</p>}
                </>
              )}

              {blog5.title6 && (
                <>
                  <h4 className="font-semibold text-black mb-1">{blog5.title6}</h4>
                  {blog5.description6_2 && <p className="mt-0">{blog5.description6_2}</p>}
                </>
              )}

              {blog5.title7 && (
                <>
                  <h4 className="font-semibold text-black mb-1">{blog5.title7}</h4>
                  {blog5.description7_2 && <p className="mt-0">{blog5.description7_2}</p>}
                  {blog5.description7_3 && <p>{blog5.description7_3}</p>}
                </>
              )}
                </div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12 border-t border-gray-200 pt-8">
  ...
  <div>
    <h3 className="text-lg font-black uppercase mb-5 tracking-tight">
      {translations.related5?.categoryTitle || "IN SAME CATEGORY"}
    </h3>
    <ul className="space-y-4 text-sm text-black">
      {[
        {
          title: translations.related5?.doSolar,
          href: "/blog/blog1"
        },
        {
          title: translations.related5?.albaniaDelayed,
          href: "/blog/blog2"
        },
        {
          title: translations.related5?.rapsodiaTaste,
          href: "/blog/blog4"
        },
        {
          title: translations.related5?.highEfficiency,
          href: "/blog/blog3"
        }
  ...
  <div>
    <h3 className="text-lg font-black uppercase mb-5 tracking-tight">
      {translations.related5?.tagsTitle || "RELATED BY TAGS"}
    </h3>
    <ul className="space-y-4 text-sm text-black">
      {/* Add tag links when tags exist */}
      {(translations.related5?.relatedByTags || []).map((title, index) => (
        <li key={index} className="border-b border-dotted border-gray-300 pb-2">
...
<div className="mt-12 max-w-2xl">
  ...
  <form className="space-y-6 text-sm text-black">
    ...
    <div className="flex flex-col md:flex-row md:items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        <img
          src="/img/captcha5.jpg" // Replace with actual captcha image source
          alt="captcha"
