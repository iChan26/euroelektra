...
const blog2 = [
  ...
  const filteredblog2 =
    activeCategory === "All"
      ? blog2
      : blog2.filter((blog2) =>
          blog2.categories.includes(activeCategory)
        );
...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-5xl ml-8">
    <h1 className="text-5xl sm:text-6xl font-bold uppercase leading-tight mb-4 animate-fade">
       {translations.heroBlog2?.title}
    </h1>
    <div className="w-24 h-1 bg-white mb-4" />
   <p className="flex items-center gap-2">
  <FaHome className="text-[#ffffff]" />
  / <span className="font-semibold text-[#58a3ff]">{translations.heroBlog2?.breadcrumb || "Loading..."}</span>
</p>
  </div>
</section>
{/*
<div className="relative z-20 max-w-5xl ml-8">
  ...
  <p className="flex items-center gap-2 text-base sm:text-lg text-gray-200 animate-fade-in">
    ...
    <span className="font-semibold text-[#58a3ff]">
      {translations.heroBlog?.breadcrumb || "Loading..."}
    </span>
  </p>
</div>
*/}
...
<section className="py-10 px-6 bg-white">
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    ...
    <div className="space-y-10">
      {filteredblog2.map((item, index) => {
        const blog2 = translations.blog2?.[item.key];
        const meta = translations.blog1Meta || {};

        if (!blog2) return null;
...
<div className="flex flex-wrap items-center text-sm text-[#333] gap-x-5 gap-y-3 mb-4">
  ...
  <span className="flex items-center gap-1">
    ...
    <span className="ml-1">10845</span>
  </span>
</div>
...
{blog2?.title1 && (
  <>
    <h4 className="font-semibold text-black mb-1">{blog2.title1}</h4>
    {blog2.description1 && <p className="mt-0">{blog2.description1}</p>}
  </>
)}

{/* Paragraphs Section */}
{blog2.description1_2 && <p>{blog2.description1_2}</p>}
{blog2.description1_3 && <p>{blog2.description1_3}</p>}
{blog2.description2 && <p>{blog2.description2}</p>}
{blog2.description2_2 && <p>{blog2.description2_2}</p>}
{blog2.description2_3 && <p>{blog2.description2_3}</p>}
{blog2.description2_4 && <p>{blog2.description2_4}</p>}
{blog2.description2_5 && <p>{blog2.description2_5}</p>}

{/* Legal & Meeting Info */}
{blog2.description3 && <p>{blog2.description3}</p>}
{blog2.description3_2 && <p>{blog2.description3_2}</p>}
{blog2.description4 && <p>{blog2.description4}</p>}
{blog2.description4_2 && <p>{blog2.description4_2}</p>}
{blog2.description4_3 && <p>{blog2.description4_3}</p>}
{blog2.description4_4 && <p>{blog2.description4_4}</p>}
{blog2.description4_5 && <p>{blog2.description4_5}</p>}

{/* Source */}
{blog2.source && <p>{blog2.source}</p>}
...
<div className="mt-6 flex items-start flex-wrap gap-2 text-sm">
  ...
  <span className="text-[#888] mr-2 font-medium">
    {translations.tags2?.tagsLabel || "Tags:"}
  </span>

  {/* Dynamic Tags with Translated Labels */}
  {[
    { key: "euroelektra", label: translations.tags2?.tag_euroelektra || "euroelektra", href: "/filter_blog/euroelektra" },
    { key: "photovoltaic-sector", label: translations.tags2?.tag_sunpower || "photovoltaic sector", href: "/filter_blog/photovoltaicsector" },
    { key: "photovoltaic-panels", label: translations.tags2?.tag_solar_panels || "photovoltaic panels", href: "/filter_blog/photovoltaicpanels" },
    { key: "Solar-panels", label: translations.tags2?.tag_solarpanels || "Solar panels", href: "/filter_blog/solarpanels" },
    { key: "solar-energy", label: translations.tags2?.tag_solar_energy || "Solar Energy", href: "/filter_blog/solarenergy"},
    { key: "photovoltaic-market", label: translations.tags2?.tag_winter || "photovoltaic market", href: "/filter_blog/photovoltaicmarket"},
    { key: "albania-energy-sector", label: translations.tags2?.tag_renewable_energy || "albania energy sector", href: "/filter_blog/albaniaenergysector" },
    { key: "renewable-energy", label: translations.tags2?.tag_solar_company || "renewable energy", href: "/filter_blog/renewableenergy" },
  ].map((tag, index) => {
    return (
      <a
        key={index}
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12 border-t border-gray-200 pt-8">
  ...
  <div>
    <h3 className="text-lg font-black uppercase mb-5 tracking-tight">
      {translations.related2?.categoryTitle || "IN SAME CATEGORY"}
    </h3>
    <ul className="space-y-4 text-sm text-black">
      {[
        { key: "doWinter", href: "/blog/blog1" },
        { key: "businessBenefits", href: "/blog/blog5" },
        { key: "rapsodia", href: "/blog/blog4" },
        { key: "highEfficiency", href: "/blog/blog3" },
      ].map(({ key, href }, index) => (
        <li key={index} className="border-b border-dotted border-gray-300 pb-2">
          <a href={href} className="hover:underline">
            {translations.related2?.[key]}
          </a>
        </li>
      ))}
    </ul>
  ...
  <div>
    <h3 className="text-lg font-black uppercase mb-5 tracking-tight">
      {translations.related2?.tagsTitle || "RELATED BY TAGS"}
    </h3>
    <ul className="space-y-4 text-sm text-black">
      {[
        { key: "dosolar", href: "/blog/blog1" },
        { key: "albaniaDelayed", href: "/blog/blog2" },
      ].map(({ key, href }, index) => (
        <li key={index} className="border-b border-dotted border-gray-300 pb-2">
          <a href={href} className="hover:underline">
            {translations.related2?.[key]}
...
<div className="mt-12 max-w-2xl">
  ...
  <form className="space-y-6 text-sm text-black">
    ...
    <div className="flex flex-col md:flex-row md:items-center gap-2">
      ...
      <div className="flex items-center gap-2">
        <img
          src="/img/captcha2.jpg" // Replace with actual captcha image source
          alt="captcha"
