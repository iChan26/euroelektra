...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-5xl ml-8">
    <h1 className="text-5xl sm:text-6xl font-bold uppercase leading-tight mb-4 animate-fade">
       {translations.renewableenergy_product?.title || "Loading..."}
    </h1>
  ...
  / <span className="font-semibold text-[#58a3ff]">{translations.renewableenergy_product?.breadcrumb}</span>
</p>
  </div>
</section>
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    ...
    <aside>
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">
        {translations.renewableenergy_product?.category_photovoltaic || "Residential"}
      </h2>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
  {[
    {
      title: "SunPower P19 405Wp",
      label: translations.photovoltaicpanels_product?.sunpower || "SunPower P19 405Wp",
      image: "/img/sunpower.png",
    },
    {
      title: "Peimar Photovoltaic Modules",
      label: translations.photovoltaicpanels_product?.Peimar || "Peimar Photovoltaic Modules",
      image: "/img/peimar.jpg",
    },
    {
      title: "AXITEC Photovoltaic Modules",
      label: translations.photovoltaicpanels_product?.AXITEC || "AXITEC Photovoltaic Modules",
      image: "/img/axitec.jpg",
    },
    {
      title: "QCELLS - Q.PEAK DUO-G5",
      label: translations.photovoltaicpanels_product?.QCELLS || "QCELLS - Q.PEAK DUO-G5",
      image: "/img/qcells.jpg",
    },
  ].map((sector, idx) => (
    <div
      key={idx}
