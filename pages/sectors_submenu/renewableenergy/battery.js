...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  / <span className="font-semibold text-[#58a3ff]">{translations.renewableenergy_photovoltaicinverter?.breadcrumb1}</span>
</p>
  </div>
</section>
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    ...
    <aside>
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">
        {translations.renewableenergy_photovoltaicinverter?.category_batery || "Residential"}
      </h2>
    ...
    {/* Grid with Images */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
          {[
            {
              key: "Fronius solar battery",
              label: translations.battery_product?.Froniussolarbattery || "IntFronius solar batteryerior",
              image: "/img/Froniussolarbattery.jpg",
             
            },
            {
              key: "Sunny Boy Storage",
              label: translations.battery_product?.SunnyBoyStorage || "Sunny Boy Storage",
              image: "/img/sunnyboybattery.jpg",
