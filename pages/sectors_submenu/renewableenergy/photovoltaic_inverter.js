...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-5xl ml-8">
    <h1 className="text-5xl sm:text-6xl font-bold uppercase leading-tight mb-4 animate-fade">
       {translations.renewableenergy_photovoltaicinverter?.title || "Loading..."}
    </h1>
  ...
  / <span className="font-semibold text-[#58a3ff]">{translations.renewableenergy_photovoltaicinverter?.breadcrumb}</span>
</p>
  </div>
</section>
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    ...
    <aside>
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">
        {translations.renewableenergy_photovoltaicinverter?.category_photovoltaic || "Photovoltaic Inverter"}
      </h2>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
  {[
    {
      title: "Fronius Eco",
      label: translations.photovoltaicinverter_product?.FroniusEco || "Fronius Eco",
      image: "/img/froniusEco.jpg",
    },
    {
      title: "Fronius Galvo",
      label: translations.photovoltaicinverter_product?.FroniusGalvo || "Fronius Galvo",
      image: "/img/FroniusGalvo.jpg",
    },
    {
      title: "Fronius Symo",
      label: translations.photovoltaicinverter_product?.FroniusSymo || "Fronius Symo",
      image: "/img/FroniusSymo.jpeg",
    },
    {
      title: "SMA Sunny Boy",
      label: translations.photovoltaicinverter_product?.SMASunnyBoy || "SMA Sunny Boy",
      image: "/img/SMASunnyBoy.jpg",
    },
    {
      title: "SMA Sunny Tripower 15000TL / 20000TL / 25000TL",
      label: translations.photovoltaicinverter_product?.SMASunnyTripower || "SMA Sunny Tripower 15000TL / 20000TL / 25000TL",
      image: "/img/SMASunnyTripower.png",
    },
    {
      title: "SMA Sunny Highpower Peak1",
      label: translations.photovoltaicinverter_product?.SMASunnyHighpower || "SMA Sunny Highpower Peak1",
      image: "/img/SMASunnyHighpower.jpg",
    },
    {
      title: "Fronius Primo",
      label: translations.photovoltaicinverter_product?.FroniusPrimo || "Fronius Primo",
      image: "/img/FroniusPrimo.jpg",
    },
  ].map((sector, idx) => (
    <div
      key={idx}
