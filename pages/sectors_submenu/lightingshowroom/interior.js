...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-5xl ml-8">
    <h1 className="text-5xl sm:text-6xl font-bold uppercase leading-tight mb-4 animate-fade">
       {translations.interior_product?.title || "Loading..."}
    </h1>
  ...
  / <span className="font-semibold text-[#58a3ff]">{translations.interior_product?.breadcrumb}</span>
</p>
  </div>
</section>
<section className="py-10 px-6 bg-white">
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    ...
    <aside>
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">
        {translations.interior_product?.category_interior || "Interior"}
      </h2>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
  {[
    {
      title: "Gold Novalux",
      label: translations.interior?.gold || "Gold Novalux",
      image: "/img/gold_novalux.jpg",
    },
    {
      title: "Novalux Spyglass",
      label: translations.interior?.spyglass || "Novalux Spyglass",
      image: "/img/novalux_spyglass.jpg",
    },
    {
      title: "Linearbay Novalux",
      label: translations.interior?.linearbay || "Linearbay Novalux",
      image: "/img/linearbay.png",
    },
  ].map((sector, idx) => (
    <div
      key={idx}
