...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-5xl ml-8">
    <h1 className="text-5xl sm:text-6xl font-bold uppercase leading-tight mb-4 animate-fade">
       {translations.exterior_product?.title || "Loading..."}
    </h1>
  ...
  / <span className="font-semibold text-[#58a3ff]">{translations.exterior_product?.breadcrumb}</span>
</p>
  </div>
</section>
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    ...
    <aside>
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">
        {translations.exterior_product?.category_exterior || "Exterior"}
      </h2>
    ...
    {/* Grid with Images */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
        {[
          {
            title: "Ground pro Novalux",
            label: translations.exterior?.ground || "Ground pro Novalux",
            image: "/img/ground_pro_novalux.jpg",
          },
          {
            title: "Screen Novalux",
            label: translations.exterior?.screen || "Screen Novalux",
            image: "/img/screen_novalux.jpg",
          },
          {
            title: "Stone Applique",
            label: translations.exterior?.stone || "Stone Applique",
            image: "/img/stone_applique.jpg",
          },
        ].map((sector, idx) => (
          <div
            key={idx}
