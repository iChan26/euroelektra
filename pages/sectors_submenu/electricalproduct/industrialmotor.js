...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  / <span className="font-semibold text-[#58a3ff]">{translations.motorsstarters?.breadcrumb}</span>
</p>
  </div>
</section>
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    ...
    <aside>
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">
        {translations.motorsstarters?.category_motor || "Industrial"}
      </h2>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
  {[
    {
      title: "Control Relay Tesys D",
      label: translations.motorsstarters?.ControlD || "Control Relay Tesys D",
     href: "/storemotor",
     id: "controlD",
      image: "/img/ControlD.jpg",
    },
    {
      title: "Control Relay Tesys K",
      label: translations.motorsstarters?.ControlK || "Control Relay Tesys K",
       href: "/storemotor",
        id: "ControlK",
      image: "/img/ControlK1.jpg",
    },
    ...
    return sector.href ? (
     <Link key={idx} href={`${sector.href}?id=${sector.id}`}>
    {content}
  </Link>
    ) : (
