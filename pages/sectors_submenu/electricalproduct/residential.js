...
const products = [
  {
    id: "eikon4d",
    name: "EIKON 4D",
    subtitle: "EIKON 4D luxury and technology",
    description:
  ...
  },
  {
    id: "arke",
    name: "ARKE'",
    subtitle: "ARKE' lives in your time",
    description:
  ...
  },
  {
    id: "plana",
    name: "PLANA",
    subtitle: "PLANA - Essentially Functional and Economic",
    description:
      "Discover Plana - unique, essential, universal, linear, international.",
    image: "/img/plana1.jpg",
  },
];
...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  / <span className="font-semibold text-[#58a3ff]">{translations.electricalproduct_residential?.breadcrumb}</span>
</p>
  </div>
</section>
...
<section className="py-10 px-6 bg-white">
   ...
   {/* 🟦 SIDEBAR */}
    <aside className="w-full md:w-[250px] max-h-[415px] overflow-y-auto pr-2">
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">
        {translations.electricalproduct_residential?.electrical_residential || "Electrical Products"}
      </h2>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
  {[
    {
      title: "EIKON 4D",
      label: translations.residential?.EIKON_4D || "EIKON 4D",
       id: "eikon4d",
      href: "/store",
      image: "/img/eikon.jpg",
    },
    {
      title: "ARKE",
      label: translations.residential?.ARKE || "ARKE",
       id: "arke",
      href: "/store",
      image: "/img/arke.jpg",
    },
    {
      title: "PLANA",
      label: translations.residential?.PLANA || "PLANA",
       id: "plana",
      href: "/store",
      image: "/img/plana1.jpg",
    },
    ...
    <Link
      key={idx}
      href={`${sector.href}?id=${sector.id}`} // ✅ add query string with product id
