...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  / <span className="font-semibold text-[#58a3ff]">{translations.electricalproduct_IT_infrastructure?.breadcrumb}</span>
</p>
  </div>
</section>
  ...
  {/* 🟦 SIDEBAR */}
    <aside className="w-full md:w-[250px] max-h-[415px] overflow-y-auto pr-2">
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">
        {translations.electricalproduct_IT_infrastructure?.electrical_products || "Electrical Products"}
      </h2>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
  {[
    {
      title: "Rack",
      label: translations.IT_industrial?.Rack || "Rack",
      image: "/img/rack.jpg",
    },
    {
      title: "VOIP Systems",
      label: translations.IT_industrial?.VOIP_Systems || "VOIP Systems",
      image: "/img/voip_systems.jpg",
    },
    {
      title: "Access point",
      label: translations.IT_industrial?.Access_point || "Access point",
      image: "/img/access_point.png",
    },
    {
      title: "Data Center",
      label: translations.IT_industrial?.Data_Center || "Data Center",
      image: "/img/data_center.jpg",
    },
  ].map((sector, idx) => (
    <div
      key={idx}
