...
<section className="relative min-h-screen flex items-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-5xl ml-8">
    <h1 className="text-5xl sm:text-6xl font-bold uppercase leading-tight mb-4 animate-fade">
       {translations.electricalproduct_residential?.title || "Loading..."}
    </h1>
  ...
  / <span className="font-semibold text-[#58a3ff]">{translations.electricalproduct_industrial?.breadcrumb}</span>
</p>
  </div>
</section>
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    ...
    <aside className="w-full md:w-[250px] max-h-[415px] overflow-y-auto pr-2">
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">
        {translations.electricalproduct_industrial?.electrical_industrial || "Electrical Products"}
      </h2>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
  {[
    {
      title: "Motor starters and Protection Components",
      label: translations.industrial?.motor || "Motor starters and Protection Components",
     href: "/sectors_submenu/electricalproduct/industrialmotor",
      image: "/img/motor.jpg",
    },
    {
      title: "PLC",
      label: translations.industrial?.complete || "PLC",
      image: "/img/PLC.jpg",
    },
    {
      title: "Complete Control Buttons",
      label: translations.industrial?.plc || "Complete Control Buttons",
      image: "/img/complete_control_btn.jpg",
    },
  ].map((sector, idx) => {
    const content = (
      <div className="border border-gray-200 rounded-lg p-4 flex flex-col items-center justify-center text-center bg-white shadow-sm hover:shadow-lg hover:-translate-y-1 transition duration-300">
        <img
          src={sector.image}
          alt={sector.title}
