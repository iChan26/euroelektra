...
const blogs = [
  {
    ...
    link: "/blog/blog2", // ✅ must start with `/` (public route)
    readMoreLink: "/blog/blog2#details", // ✅ anchor to section inside the blog
  }
];
   ...
   <div className="relative z-20 max-w-5xl ml-8">
      ...
      <p className="flex items-center gap-2 text-base sm:text-lg text-gray-200 animate-fade-in">
        ...
        <span className="font-semibold text-[#58a3ff]">
          {translations.heroBlog?.photovoltaicpanels || "Loading..."}
        </span>
      </p>
    </div>
</section>
