...
<section className="relative min-h-screen flex items-center justify-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-4xl text-center">
    ...
    <p className="text-lg sm:text-xl font-medium text-white max-w-3xl mx-auto">
      Our Lighting showroom Product provide high quality, sustainability, energy efficiency, and environmentally friendly solutions — aligning with EuroElektra's mission to power the future through innovation and smart energy systems.
    </p>
  </div>
</section>
<section className="py-10 px-6 bg-white">
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10">
    {/* Sidebar */}
    <aside>
      <h2 className="text-lg font-semibold text-[#1C1C1C] mb-4">Electical Product</h2>
