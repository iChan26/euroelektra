...
<section className="relative min-h-screen flex items-center justify-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-4xl text-center">
    ...
    <p className="text-lg sm:text-xl font-medium text-white max-w-3xl mx-auto">
      Our Smart Building Product provide high quality, sustainability, Smart Building, and environmentally friendly solutions — aligning with EuroElektra's mission to power the future through innovation and smart energy systems.
    </p>
  </div>
</section>
<section className="bg-white px-6 py-16 border-t border-gray-200">
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10 items-start">
    ...
    <aside className="space-y-4">
      <h2 className="text-[#1C1C1C] font-semibold text-lg">SECTORS</h2>
    ...
    <div className="space-y-10">
      ...
      <div className="bg-[#F5F7FA] p-6 rounded-md shadow-sm border border-gray-200 flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 space-y-4">
          <h3 className="text-[#003B5C] font-bold text-lg uppercase">Home control</h3>
        ...
        <div className="flex-shrink-0 w-full md:w-[300px] flex justify-center items-center">
          <img
            src="/img/80006c2b-b6b9-4576-bfd7-f747909b6e60 (1).PNG"
      ...
      <div className="bg-[#F5F7FA] p-6 rounded-md shadow-sm border border-gray-200 flex flex-col md:flex-row gap-6">
        ...
        {/* Text */}
        <div className="flex-1 space-y-4">
          <h3 className="text-[#003B5C] font-bold text-lg uppercase">With By-web app you can manage and view the main system functions from your smartphone.</h3>
          <p className="text-[#4F4F4F] text-sm leading-relaxed">
      ...
      <div className="bg-[#F5F7FA] p-6 rounded-md shadow-sm border border-gray-200 flex flex-col md:flex-row gap-6">
        ...
        {/* Text */}
        <div className="flex-1 space-y-4">
          <h3 className="text-[#003B5C] font-bold text-lg uppercase">Nothing escapes you, the whole home is just a simple, intuitive touch away.</h3>
          <p className="text-[#4F4F4F] text-sm leading-relaxed">
    ...
    Simply select the various rooms in the home and control all the functions, from a single point.
        ...
        <div className="flex-shrink-0 w-full md:w-[300px] flex justify-center items-center">
          <img
            src="/img/01143bdb-c9bf-441a-8500-f6f9e5954944.PNG"
            alt="Electrical Products"
            className="rounded-md border border-gray-300 object-contain"
          />
        </div>
