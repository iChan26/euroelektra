...
<section className="relative min-h-screen flex items-center justify-center px-6 text-white bg-black overflow-hidden">
  ...
  <div className="relative z-20 max-w-4xl text-center">
    ...
    <p className="text-lg sm:text-xl font-medium text-white max-w-3xl mx-auto">
      Our Energy Efficiency Product provide high quality, sustainability, energy efficiency, and environmentally friendly solutions — aligning with EuroElektra's mission to power the future through innovation and smart energy systems.
    </p>
  </div>
</section>
    ...
    <div className="space-y-10">
      ...
      <div className="bg-[#F5F7FA] p-6 rounded-md shadow-sm border border-gray-200 flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 space-y-4">
          <h3 className="text-[#003B5C] font-bold text-lg uppercase">Climate comfort</h3>
      ...
      <div className="bg-[#F5F7FA] p-6 rounded-md shadow-sm border border-gray-200 flex flex-col md:flex-row gap-6">
        ...
        {/* Text */}
        <div className="flex-1 space-y-4">
          <h3 className="text-[#003B5C] font-bold text-lg uppercase">Smart management</h3>
          <p className="text-[#4F4F4F] text-sm leading-relaxed">
